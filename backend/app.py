...
def _normalize_trade_row(row: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "submit_latency_ms": extra.get("submit_latency_ms"),
        "fill_seen_latency_ms": extra.get("fill_seen_latency_ms"),
        "managed_latency_ms": extra.get("managed_latency_ms"),
        "end_to_end_entry_ms": extra.get("end_to_end_entry_ms"),
        "close_submit_latency_ms": extra.get("close_submit_latency_ms"),
        "close_ack_to_closed_ms": extra.get("close_ack_to_closed_ms"),
